  ...
  return (
    ...
    >
      ...
      <Link href={links[i].href} className="capitalize flex items-center">
        <div className=" w-10 h-10  md:w-14 md:h-14 lg:w-20 lg:h-20 rounded-full  mr-5 flex justify-center items-center"
          style={{ border: `2px solid${colors[i]}`, backgroundImage: `url(${images[i].src})`, backgroundPosition: "center",objectFit:"contain",backgroundRepeat:"no-repeat" }}>
